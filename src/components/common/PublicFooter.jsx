        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="col-span-1 lg:col-span-1 space-y-6">
            <div className="flex items-center gap-3">
              <AppLogo size="md" forceTheme="dark" />
          ...
          {/* Community */}
          <div className="space-y-6">
            <h4 className="text-xs font-black uppercase tracking-widest text-white">Community</h4>
            <ul className="space-y-4">
              <li><Link to="/#pricing" className="text-sm text-gray-400 hover:text-primary transition-colors font-bold">Pricing Mission</Link></li>
              <li><Link to="/#feedback" className="text-sm text-gray-400 hover:text-primary transition-colors font-bold">Direct Support</Link></li>
              <li><a href="mailto:omarselema52@gmail.com" className="text-sm text-gray-400 hover:text-primary transition-colors font-bold">Partner Program</a></li>
            </ul>
          </div>

          {/* Trust & Legal */}
          <div className="space-y-6">
            <h4 className="text-xs font-black uppercase tracking-widest text-white">Trust & Security</h4>
            <ul className="space-y-4">
